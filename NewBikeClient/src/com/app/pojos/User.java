...
List<Vehicle> u_vehicles = new ArrayList<>(); //Enter By User	

										//(Select Using Drop-Down List)-->(Take data from Vehicle Entity)	
List<Order> u_order = new ArrayList<>();				//Previous Orders Placed By User


public User() {
	System.out.println("In The Default Constructor of User ");
}
	...
	public User(String u_email, String u_password) {
		...
		System.out.println("In The email adn password Constructor of User ");
	}
...
/*	@ElementCollection
	...
	public String toString() {
		return "User [u_id=" + u_id + ", u_first_name=" + u_first_name + ", u_last_name=" + u_last_name + ", u_email="
				...
				+ ", u_vehicles=" + u_vehicles + ", u_order=" + u_order + "]";
	}
