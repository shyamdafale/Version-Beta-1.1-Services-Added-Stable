...
public class Vehicle {
	...
	public Vehicle() {
		System.out.println("In The Default Constructor of Vehicle");
	}
	
	public Vehicle(int v_id) {
		System.out.println("\n\nVehicle With ID Constructor Client\n\n");
	}
	...
	public Vehicle(int v_id,String v_company_name, String v_model, String v_regNo) {
		super();
		this.v_id = v_id;
		this.v_company_name = v_company_name;
		this.v_model = v_model;
