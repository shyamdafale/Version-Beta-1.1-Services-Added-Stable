 ...
 <div align="center">
      ...
      <form class="d-none d-lg-inline-block form-inline col-md-8">
        <div class="input-group">
          <input type="text" class="form-control" placeholder="Search for Service Centers..." aria-label="Search" aria-describedby="basic-addon2">
...
<%-- 	 <c:forEach var="v" items="${sessionScope.session_user.u_vehicles}" >
 ...
 <!-- Project Three -->
      <div class="row">
        ...
        <div class="col-md-5">
          <h3>Project Three</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.t unde repudiandae voluptatum sit ab debitis suscipit fugiat natus velit excepturi amet commodi deleniti alias possimus!</p>
          <a class="btn btn-primary" href="#">Book Service Now</a>
        </div>
      </div>
      <!-- /.row -->
