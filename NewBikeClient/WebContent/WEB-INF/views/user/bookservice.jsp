...
<c:if test="${not empty sessionScope.session_vendor}">
	...
	<center>
	<button class="btn btn-danger text-white " id="toggleme">Check Available Services</button>
	<a class="btn btn-info text-white" href="<spring:url value='/user/visitvendorshop?ven_id=${v.ven_id}'/>"> Book A Service </a>
	<br><br>
